import cv2,time,autopy;import numpy as np;import Hand_Tracking_Module as htm
frame,wcam,hcam,smooth,px,py,cx,cy,pt=100,640,480,2,0,0,0,0,0
cap=cv2.VideoCapture(1);cap.set(3,wcam),(4,hcam);detector=htm.handDetector(maxHands=1);wScr,hScr=autopy.screen.size()
while True:
